/* ============================================================
   ...
   - Cambia automáticamente a gemini-3.6-flash
...
(function () {
  ...
  function friendlyError(e) {
    ...
    if (status === 404) {
      if (/no longer available|not available to new users|models\/.* is no longer|NOT_FOUND/i.test(msg)) {
        return "HTTP 404: ese modelo ya no está disponible para tu cuenta. Pulsa 'Listar modelos' o usa gemini-3.6-flash. Detalle: " + msg;
      }
  ...
  log("Modelo recomendado: gemini-3.6-flash");
